...
//	checksession();
	...
	header("location:myorders-new.php");
	exit;
	}
	$i=1;
	
	$base_qry="select order_dtm, A.order_id,A.cust_phone,A.cust_name,   A.cust_add, COUNT(item_id), SUM(quantity*unit_price), order_status from order_header A, order_items B where A.order_id = B.order_id and A.order_status = 'N' and A.biz_id=$biz_id GROUP BY A.order_id";	
//echo $base_qry;
