...
//	checksession();
	...
	header("location:myorders-rejected.php");
	exit;
	}
	$i=1;
	
	$base_qry="select order_dtm, A.order_id,A.cust_phone,A.cust_name,   A.cust_add, COUNT(item_id), SUM(quantity*unit_price), order_status from order_header A, order_items B where A.order_id = B.order_id and A.order_status = 'R' and A.biz_id=$biz_id GROUP BY A.order_id";	
//echo $base_qry;
...
@media only screen and (max-width: 800px) {
	...
	<h2 class="text-primary text-center">View Orders</h2>
	 ...
	 ?>	
				...
				<tr>
					...
					<!--<td data-title="Delete Item">
						<form action = "sales-orders.php" method="POST" onClick="return confirmDelete(this)">
