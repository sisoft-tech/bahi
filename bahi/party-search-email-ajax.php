...
$get=$_POST['p_cust_email'];

	$breakline=0;
	$sql = "SELECT account_id, account_name, phone_num, email FROM account_ledger WHERE biz_id='$biz_id' and ac_group_code='$act_grp' and email LIKE '%$get%' order by account_name";
	...
	{
		$breakline++;
		echo "<option value=".$record['account_id'].":".$record['account_name'].">".$record['account_name'].":".$record['email']."</option>"; 
