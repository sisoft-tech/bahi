...
$get=$_POST['p_cust_name'];
$act_grp = $_POST['p_act_grp'];

$breakline=0;
$sql = "SELECT account_id, account_name, phone_num FROM account_ledger  WHERE biz_id='$biz_id' and ac_group_code ='$act_grp' and account_name LIKE '%$get%' order by account_name";
...
while($record=mysqli_fetch_array($fetch))
{
	...
	echo "<option value=".$record['account_id'].":".$record['account_name'].">".$record['account_name']."</option>"; 
