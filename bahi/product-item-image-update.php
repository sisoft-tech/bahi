...
header("location:product-item-image-manage.php");
...
<div class ="container-fluid" >
  ...
  <h2 class="text-primary text-center">Update Product Item Image</h2><br>
  </div>      
...
<form class="form-horizontal" style="margin-left:10%;" method="POST" >
  ...
  <div class="col-md-3">
	<input readonly  name="item_name"  placeholder="" required=required class="form-control input-md" type="text" value="<?php echo $rows['item_name']; ?>">
  </div>

  <label class="control-label col-md-2"  for="bar_code">Item Display Name</label>  
  <div class="col-md-2">
	<input readonly  name="item_disp_name" id="item_disp_name"  placeholder="" class="form-control input-md" type="text" value="<?php echo $rows['item_disp_name']; ?>">
  </div>
...
<div class="form-group row">
  ...
  <div class="col-md-3">
	<input readonly  name="item_desc"  placeholder="" required=required class="form-control input-md" type="text" value="<?php echo $rows['item_desc']; ?>">
  </div>
</div>
...
<div class="form-group" style="margin-left:35%;">
  ...
  <div>
    <input type="submit" name="update" class="btn btn-info" value="Update" style="padding:10px 3%; border-radius:0; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);"/>
     <input type="reset" name="cancel" class="btn btn-default" value="Cancel" onClick="location.href = 'product-item-image-manage.php';" style="padding:10px 3%; border-radius:0; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);"/>
	</div>
</div>
</form>
