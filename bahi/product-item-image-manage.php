...
@media only screen and (max-width: 800px) {
	...
	<h2 class="text-primary text-center">Manage Product Item Images</h2>
	...
	<thead>
		...
		<th style='color:#b30059; text-align:center;'>Item Image 1</th>
		<th style='color:#b30059; text-align:center;'>Item Image 2</th>
		<th style='color:#b30059; text-align:center;'>Created Date</th>
		<th style='color:#b30059; text-align:center;'>Created By</th>
<!--        <th style='color:#b30059; text-align:center;'>Review Status</th>  -->
        <th style='color:#b30059; text-align:center;'>Update Image</th>
	...
	<?php
	 ...
	 ?>	
				...
				<tr>
					...
					<td data-title="Item Image 1"><img src="<?php echo $row['img_path1'] ;?>" alt="Image1" height="50" width="50"></td>
					<td data-title="Item Image 2"><img src="<?php echo $row['img_path2'] ;?>" alt="Image2" height="50" width="50"></td>
...
<!--					<td data-title="Review Status"><?php echo $row['review_status'] ; ?></td> -->
                    ...
                    <td data-title="Upload Item">
						<form action = "product-item-image-update.php" method="POST" >
